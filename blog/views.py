...
def get_blog_list_common_data(request, blogs_all_list):
    context = {}
    paginator = Paginator(blogs_all_list, settings.EACH_PAGE_BLOGS_NUM)  # 分页 每十条一页
    ...
    # 获取每个分类对应的数量 annotate是注释 相当于是在类中添加了一个字段
...
def blog_with_type(request, blog_with_type_pk):
    blog_type = BlogType.objects.get(pk=blog_with_type_pk)
